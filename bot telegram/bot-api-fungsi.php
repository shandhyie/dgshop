...
function sendApiPhoto($chatid){
	...
	$post_fields = array('chat_id'   => $chatid,
	    'photo'     => new CURLFile(realpath("file/gambar/awal.png"))
...
function sendApi_foto_buku($chatid, $gambar){
	$bot_url    = "https://api.telegram.org/bot".$GLOBALS['token']."/";
	$url        = $bot_url . "sendPhoto?chat_id=" . $chatid ;

	$post_fields = array('chat_id'   => $chatid,
	    'photo'     => new CURLFile(realpath("../assets/baru/data-foto/foto-buku/$gambar"))
	    // 'reply_markup' => json_encode(array('inline_keyboard' => $keyboard))
	);
